...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This value determines the company logo.
    |
    */

    'logo' => env('APP_LOGO', 'front/images/logos/logo.png'),
    'logo_auth' => env('APP_LOGO_AUTH', 'front/images/logos/logo.png'),
    ...
    |--------------------------------------------------------------------------
    |
    | This image is exhibited as default when no image is available
    | *Must* be PNG or JPG
    |
    */

    'default_image' => 'images/imagem-padrao.png',
    ...
    |--------------------------------------------------------------------------
    |
    | This value determines the google maps api key.
    |
    */
    ...
    */
    ...
    'providers' => [
        ...
        Modules\PagePrivacy\PagePrivacyServiceProvider::class,
        Modules\Differentials\DifferentialsServiceProvider::class,
        Modules\Testimonials\TestimonialsServiceProvider::class,
