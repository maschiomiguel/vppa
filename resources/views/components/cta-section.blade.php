...
<section id="cta-section" class="cta-section pt-5 pb-2">
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-12 col-lg-10 col-xl-8">
                ...
                <div class="cta-socials d-flex flex-wrap justify-content-center align-items-center gap-1">
                    ...
                    @if ($facebook)
                        <a href="{{ $facebook }}" target="_blank" rel="noopener noreferrer" class="cta-social-link cta-social-icon-only" aria-label="Facebook">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    @if ($twitter)
                        <a href="{{ $twitter }}" target="_blank" rel="noopener noreferrer" class="cta-social-link cta-social-icon-only" aria-label="Twitter">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    @if ($linkedin)
                        <a href="{{ $linkedin }}" target="_blank" rel="noopener noreferrer" class="cta-social-link cta-social-icon-only" aria-label="LinkedIn">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-md-4 text-center text-md-start mb-4 mb-md-0">
                    <img src="{{ app(\App\Services\SiteService::class)->getSiteLogo() }}" alt="Logo" class="cta-footer-logo">
                </div>
                <div class="col-12 col-md-8 text-center text-md-end">
                    <p class="cta-footer-text text-white mb-0">
                        Transform your Instagram presence with data-driven content strategy.
                    </p>
                </div>
            </div>
        </div>
